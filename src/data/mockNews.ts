...
export const mockNews: NewsItem[] = [
  {
    ...
    summary:
      "Bitcoin spot ETFs recorded $420M in net inflows on Thursday, breaking a three-week streak of outflows. BlackRock's IBIT led the charge with $280M alone.",
  ...
  {
    id: "2026-04-04_openai-gpt5_verge",
    ...
    section: "Technology",
    summary:
      "OpenAI unveiled GPT-5 with native real-time reasoning, multimodal input processing, and a 1M token context window. Available to enterprise customers first.",
    whyItMatters:
      "Represents the largest capability jump since GPT-4. Enterprise adoption could accelerate across legal, finance, and healthcare sectors.",
    impact: "Major industry catalyst",
    tags: ["OpenAI", "LLM", "enterprise"],
    signalVsNoise: "signal",
    priority: "P1",
    relevanceScore: 82,
    dedupeKey: "openai-gpt5-launch",
    featured: true,
  },
  {
    id: "2026-04-04_eu-ai-act_reuters",
    title: "EU passes comprehensive AI regulation framework",
    source: "Reuters",
    url: "https://example.com",
    publishedAt: "2026-04-04T11:15:00Z",
    category: "AI",
    section: "Technology",
    summary:
      "The European Parliament approved the AI Act with new compliance requirements for high-risk AI systems. Companies have 12 months to comply.",
    ...
    priority: "P1",
    relevanceScore: 85,
    dedupeKey: "eu-ai-act-passage",
    featured: true,
  },
  {
    id: "2026-04-04_ethereum-pectra_coindesk",
    ...
    section: "Crypto & Markets",
    summary:
      "Ethereum's Pectra upgrade went live, reducing average gas fees from $2.40 to $1.44 and improving validator efficiency by 25%.",
    ...
    tags: ["upgrade", "DeFi", "mainnet"],
    signalVsNoise: "signal",
    priority: "P1",
    relevanceScore: 72,
    dedupeKey: "ethereum-pectra-upgrade",
    featured: false,
  },
  {
    id: "2026-04-04_apple-darwinai_ft",
    title: "Apple acquires edge AI startup for $2B",
    source: "Financial Times",
    url: "https://example.com",
    publishedAt: "2026-04-04T13:20:00Z",
    category: "Big Tech",
    section: "Technology",
    summary:
      "Apple acquired DarwinAI, a startup specializing in on-device AI inference, for $2B. The deal signals Apple's commitment to local AI processing.",
    ...
    tags: ["Apple", "M&A", "on-device"],
    signalVsNoise: "signal",
    priority: "P2",
    relevanceScore: 55,
    dedupeKey: "apple-darwinai-acquisition",
    featured: false,
  },
  {
    id: "2026-04-04_solana-tvl_defillama",
    ...
    section: "Crypto & Markets",
    summary:
      "Solana's total value locked reached $14.2B driven primarily by memecoin trading on pump.fun and Jupiter. SOL price up 12% this week.",
    ...
    tags: ["SOL", "memecoins", "TVL"],
    signalVsNoise: "noise",
    priority: "P3",
    relevanceScore: 35,
    dedupeKey: "solana-tvl-memecoin",
    featured: false,
  },
  {
    id: "2026-04-03_crowdstrike-energy_wired",
    ...
    section: "Technology",
    summary:
      "CrowdStrike identified a sophisticated APT campaign targeting US energy infrastructure. The attack uses novel supply chain compromise techniques.",
    whyItMatters:
      "Critical infrastructure attacks are escalating. Expect increased government cybersecurity spending and stricter compliance requirements.",
    impact: "Bullish for cybersecurity stocks",
    tags: ["APT", "infrastructure", "energy"],
    signalVsNoise: "signal",
    priority: "P1",
    relevanceScore: 78,
    dedupeKey: "crowdstrike-energy-apt",
    featured: false,
  },
  {
    id: "2026-04-04_socialfi-pro_cryptoslate",
    ...
    section: "Crypto & Markets",
    summary:
      "A new project called SocialFi Pro launched with $50M in VC funding, promising to tokenize social interactions. Vague whitepaper with aggressive marketing.",
    whyItMatters:
      "Another iteration of the SocialFi narrative without clear product-market fit. High VC valuation without user traction is a red flag.",
    impact: "Low — likely noise",
    tags: ["SocialFi", "VC", "hype"],
    signalVsNoise: "noise",
    priority: "P3",
    relevanceScore: 22,
    dedupeKey: "socialfi-pro-launch",
    featured: false,
  },
  {
    id: "2026-04-03_nvidia-datacenter_cnbc",
    title: "NVIDIA reports record datacenter revenue driven by AI demand",
    source: "CNBC",
    url: "https://example.com",
    publishedAt: "2026-04-03T21:00:00Z",
    category: "Big Tech",
    section: "Technology",
    summary:
      "NVIDIA's datacenter segment posted $35B in quarterly revenue, up 80% YoY. CEO Jensen Huang highlighted 'insatiable demand' for AI compute.",
    ...
    tags: ["NVIDIA", "earnings", "AI"],
    signalVsNoise: "signal",
    priority: "P1",
    relevanceScore: 90,
    dedupeKey: "nvidia-datacenter-earnings",
    featured: true,
  },
  {
    id: "2026-04-03_sec-eth-etf-options_theblock",
    ...
    section: "Crypto & Markets",
    summary:
      "The SEC pushed its decision on ETH ETF options to June, citing the need for additional public comment. Market reaction was muted.",
    ...
    priority: "P3",
    relevanceScore: 38,
    dedupeKey: "sec-eth-etf-options-delay",
    featured: false,
  },
  {
    id: "2026-04-04_cloudflare-zero-trust_techcrunch",
    ...
    section: "Technology",
    summary:
      "Cloudflare introduced AI-driven anomaly detection for its Zero Trust platform, analyzing network behavior patterns in real-time to detect threats.",
    ...
    tags: ["Cloudflare", "Zero Trust", "AI"],
    signalVsNoise: "signal",
    priority: "P2",
    relevanceScore: 52,
    dedupeKey: "cloudflare-zero-trust-ai",
    featured: false,
  },
  {
    id: "2026-04-04_celebrity-nft_decrypt",
    ...
    section: "Crypto & Markets",
    summary:
      "A major celebrity launched a 10K NFT collection on Ethereum with vague promises of metaverse access and concert tickets. Floor price dropping fast.",
    ...
    tags: ["NFT", "hype", "Ethereum"],
    signalVsNoise: "noise",
    priority: "P3",
    relevanceScore: 18,
    dedupeKey: "celebrity-nft-collection",
    featured: false,
  },
  {
    id: "2026-04-04_fed-guidance_reuters",
    title: "Fed officials signal slower easing path as inflation lingers",
    source: "Reuters",
    url: "https://example.com",
    publishedAt: "2026-04-04T17:45:00Z",
    category: "Rates",
    section: "Macro",
    summary:
      "Minutes and commentary from the latest FOMC cycle pointed to fewer cuts than markets priced for H2, with emphasis on services inflation stickiness.",
    whyItMatters: "Liquidity and discount-rate narratives drive risk assets; a higher-for-longer bias weighs on high-duration tech and speculative crypto.",
    impact: "Headwind for risk sentiment until data turns",
    tags: ["FOMC", "liquidity", "risk"],
    signalVsNoise: "signal",
    priority: "P2",
    relevanceScore: 65,
    dedupeKey: "fed-easing-path-guidance",
    featured: false,
  },
];
